    ...
    <div class="container mx-auto py-8">
        ...
        <form action="" method="POST">
            ...
            <div class="mb-4">
                ...
                <input type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" id="phone"
                    name="phone" required>
            </div>

            <div class="mb-4">
                <label for="email" class="block text-gray-700">Email</label>
                <input type="email" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" id="email"
                    name="email" required>
            </div>

            <div class="mb-4">
                <label for="address" class="block text-gray-700">Address</label>
                <input type="text" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" id="address"
            ...
            <div class="mb-4">
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center">
                        <input type="radio" class="form-radio text-indigo-600" name="delivery_method" value="mail"
                            required>
                ...
                <div class="mt-2">
                    <label class="inline-flex items-center">
                        <input type="radio" class="form-radio text-indigo-600" name="delivery_method" value="hold"
                            required>
            ...
            <button type="submit" class="bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700">Submit
                Order</button>
        </form>
    </div>
</x-app-layout>
